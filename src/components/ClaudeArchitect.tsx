...
import { claudeExam, claudeConcepts, claudeCourses } from '../data/specializations';
             ...
             return (
               <div key={concept.id} className="p-5 bg-gray-900/50 rounded-2xl border border-gray-800 group transition-all">
                 <div className="flex justify-between items-start mb-2">
                   <h4 className="font-medium text-sm text-gray-200 group-hover:text-amber-400 transition-colors flex items-center gap-2">
